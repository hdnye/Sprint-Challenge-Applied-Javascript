...
//    response.data.articles.forEach((card) => {
//     const newEntry = new ArticleCard(card); 
 
//     cards-container.appendChild(newEntry);
//   });
...
const headling = document.querySelector('.headline')
